...
import { State, getVerificationCode, topUpBalance } from '@/app/lib/actions';
...
export default function Form({  }: { }) {
  ...
  const serverSubmit = async (prevState: State, formData: FormData) => {
    // disableLoading();
    setIsLoading(false);
    const returnState: State = await topUpBalance(prevState, formData);
  ...
  return (
    <form action={formAction} aria-describedby="form-error">
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          <label htmlFor="amount" className="mb-2 block text-sm font-medium">
            Choose an account email address
          </label>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <SpinnerButton name="Top Up" state={isLoading} onClick={clientSubmit} type="submit" children="" />
